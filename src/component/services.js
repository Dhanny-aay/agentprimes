    ...
    return ( 
        ...
        <div className=" my-16 px-4 md:px-16 lg:px-24 w-full font-Outfit">
            <div className=" w-full flex flex-col justify-center items-center">
                ...
                <p className=" mt-3 text-center text-base text-white md:text-lg text-[#c6c4c4] md:px-[15%]">Explore our diverse portfolio showcasing cutting-ec6c4c4b design, development, and tailored digital strategies</p>
                <div className=" w-full mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[32px] items-start">
                    
                    <div className="  w-full rounded-3xl p-6 bg-[#121212] transition-all border-white/5 md:h-[280px] lg:h-[220px]">
                        <img src={ terminal } className='' alt="Web development" />
                        <p className=' mt-2 font-medium text-base text-white'>Custom Website Development</p>
                    ...
                    <div className=" w-full rounded-3xl p-6 bg-[#121212] transition-all border-white/5 md:h-[280px] lg:h-[220px]">
                        ...
                        <p className=' mt-2 font-medium text-base text-white'>Property Listings Integration</p>
                        <p className=' text-[#c6c4c4] text-sm mt-2'>
                    ...
                    <div className=" w-full rounded-3xl p-6 bg-[#121212] transition-all border-white/5 md:h-[280px] lg:h-[220px]">
                        ...
                        <p className=' mt-2 font-medium text-base text-white'>Interactive Real-estate Maps</p>
                        <p className=' text-[#c6c4c4] text-sm mt-2'>Creating engaging maps to help users explore and locate real-estate easily.</p>
                    </div>
                    
                    <div className="  w-full rounded-3xl p-6 bg-[#121212] transition-all border-white/5 md:h-[280px] lg:h-[220px]">
                        <img src={ chart } className='' alt="Web development" />
                        <p className=' mt-2 font-medium text-base text-white'>Lead Generation Forms</p>
                        <p className=' text-[#c6c4c4] text-sm mt-2'>
                    ...
                    <div className=" w-full rounded-3xl p-6 bg-[#121212] transition-all border-white/5 md:h-[280px] lg:h-[220px]">
                        ...
                        <p className=' mt-2 font-medium text-base text-white'>Mobile Optimization</p>
                        <p className=' text-[#c6c4c4] text-sm mt-2'>
