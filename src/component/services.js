        ...
        <div className=" my-16 px-4 md:px-16 lg:px-24 w-full font-Outfit">
            <div className=" w-full flex flex-col justify-center items-center">
                ...
                <div className=" w-full mt-8 flex flex-col md:flex-row justify-between space-y-6 md:space-y-0 items-start">
                    <div className=" w-full md:w-[32%] rounded-3xl p-6 bg-[#f5f5f5] hover:bg-slate-400 hover:bg-opacity-20 transition-all border-white/5 md:h-[280px] lg:h-[220px]">
                    ...
                    <div className=" w-full md:w-[32%] rounded-3xl p-6 bg-[#f5f5f5] hover:bg-slate-400 hover:bg-opacity-20 transition-all border-white/5 md:h-[310px] lg:h-[250px]">
