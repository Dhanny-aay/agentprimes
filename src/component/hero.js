            ...
            <div className=" w-full flex flex-col lg:flex-row items-center justify-between">
                <div className=" w-full items-center justify-center flex flex-col">
                    ...
                    <div className=" mt-4 flex space-x-4 md:justify-normal md:space-x-6 items-center">
                        <Link to='/contact'><button className=" px-4 md:px-6 py-3 bg-[#081f5c] hover:bg-[#081e5ce9] transition-all font-Outfit flex items-center space-x-2 font-medium text-[#f5f5f5] rounded-[50px]">
                            <p>Let's Talk</p>
                            <img src={ Paper_Plane } className=' w-5' alt="" />
                        </button></Link>
                        <button className=" px-4 md:px-6 py-3 border-2 border-[#081f5c] hover:bg-slate-400 hover:bg-opacity-30 transition-all font-Outfit flex items-center space-x-2 font-medium text-[#081f5c] rounded-[50px]">
                            <p>View Portfolio</p>
