        ...
        <div className="  mt-28 md:mt-40 pb-8 md:pb-16 px-4 md:px-16 lg:px-24 w-full font-Outfit">
            <div className=" w-full flex flex-col lg:flex-row items-center justify-between">
                <div className=" w-full lg:w-[48%] flex flex-col">
                    ...
                    <p className=" mt-4 text-4xl md:text-5xl md:leading-[62px] font-medium">We are a Digital Creative Web Agency</p>
                    <p className=" mt-5 text-base font-normal text-[#4d4d4d]">Innovative digital agency that specializes in creating high-quality websites and digital marketing strategies designed to drive engagement and increase conversions.</p>
                ...
                <div className=" w-full mt-16 lg:mt-0 lg:w-[48%] flex flex-col">
