...
const Examples = () => {
    return ( 
        ...
        <div className="mt-28 md:mt-40 pb-8 md:pb-16 px-4 md:px-16 lg:px-24 w-full font-Outfit">
            <p className=" text-center text-2xl md:text-4xl text-white font-medium">Our Works</p>
            <p className=" text-center text-[#c6c4c4] font-normal px-[15%] mt-4 text-base md:text-lg capitalize">What you can expect from us</p>
            <div className=" mt-8 md:mt-16">
                <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[32px]">
                    <div className=" ">
                     ...
                     <a href="https://www.chelsealteam.ca/" target="blank" className=" mt-3 text-[#c6c4c4] text-base underline">View Site</a>
                    </div>  
                    <div className=" ">
                     ...
                     <a href="https://katiesellshalifax.com/" target="blank" className=" mt-3 text-[#c6c4c4] text-base underline">View Site</a>
                    </div>  
                    <div className=" ">
                     ...
                     <a href="https://www.teamstephens.ca/" target="blank" className=" mt-3 text-[#c6c4c4] text-base underline">View Site</a>
                    </div>  
                    <div className=" ">
                     ...
                     <a href="https://lizmartin.ca/" target="blank" className=" mt-3 text-[#c6c4c4] text-base underline">View Site</a>
                    </div>  
                    <div className=" ">
                     ...
                     <a href="https://jademillsestates.com/" target="blank" className=" mt-3 text-[#c6c4c4] text-base underline">View Site</a>
                    </div>  
                    <div className=" ">
                     ...
                     <a href="https://www.firstteam.com/agent/48321-Brian-Wilson/" target="blank" className=" mt-3 text-[#c6c4c4] text-base underline">View Site</a>
                    </div>  
                </div>
            </div>
        </div>
