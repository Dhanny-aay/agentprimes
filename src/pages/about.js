...
const About = () => {
    return ( 
        ...
        <div className="   mt-28 md:mt-40 pb-8 md:pb-16 px-4 md:px-16 lg:px-24 w-full font-Outfit">
            <p className=" text-center text-2xl md:text-4xl font-medium">About Us</p>
            <p className=" text-center text-[#4d4d4d] font-normal px-[15%] mt-4 text-base md:text-lg">We are a dynamic team comprised of talented designers, developers, and marketing experts.</p>
