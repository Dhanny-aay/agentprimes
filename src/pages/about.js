...
const About = () => {
    return ( 
        ...
        <div className="   mt-28 md:mt-40 pb-8 md:pb-16 px-4 md:px-16 lg:px-24 w-full font-Outfit">
            ...
            className=" text-center text-2xl md:text-4xl text-white font-medium">About Us</motion.p>
            <motion.p 
            initial={{ y: 20, opacity: 0 }}
            whileInView={{ y: 0, opacity: 1 }}
            transition={{ duration: 1, type:'tween' }}
            className=" text-center text-[#c6c4c4] font-normal px-[15%] mt-4 text-base md:text-lg">We are a dynamic team comprised of talented designers, developers, and marketing experts.</motion.p>

            <motion.div 
            initial={{ y: 20, opacity: 0 }}
            whileInView={{ y: 0, opacity: 1 }}
            transition={{ duration: 1, type:'tween' }}
            className=" mt-16 md:mt-16 flex flex-col lg:flex-row w-full justify-between items-center">
            ...
            <div className=" mt-16">
                ...
                whileInView={{ y: 0, opacity: 1 }}
                transition={{ duration: 1, type:'tween' }}
                className=" text-2xl md:text-4xl text-white text-center font-medium">In numbers</motion.p>
                <div className=" mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                    <motion.div
                    initial={{ y: 20, opacity: 0 }}
                    whileInView={{ y: 0, opacity: 1 }}
                    transition={{ duration: 1, type:'tween' }}
                    className=" w-full h-[150px] border-white/5 bg-[#121212] rounded-3xl p-6 flex flex-col items-start space-y-2 justify-start">
            ...
            <div className=" mt-16">
                ...
                whileInView={{ y: 0, opacity: 1 }}
                transition={{ duration: 1, type:'tween' }}
                className=" text-2xl text-white md:text-4xl text-center font-medium">Our Values</motion.p>
                <div className=" mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                    <motion.div
                    initial={{ y: 20, opacity: 0 }}
                    whileInView={{ y: 0, opacity: 1 }}
                    transition={{ duration: 1, type:'tween' }}
                    className=" w-full md:h-[290px] lg:h-[230px] border-white/5 bg-[#121212] rounded-3xl p-6 flex flex-col items-start space-y-2 justify-start">
